...
<form method="post">
	<div class="container" style="width: 500px; margin-top: 200px;">
		<h2 class="text-light text-center">Quên mật khẩu</h2>
		<div class="form-floating mb-3">
			<input type="email" class="form-control" name="email"
				id="floatingEmail" placeholder="name@example.com"> <label 
				for="floatingEmail">Email</label>
		</div>
		<h6 class="text-center text-primary fw-bold">${matkhauquen}</h6>
		<div class="mt-2 text-center">
			<button class="btn btn-dark  mb-3 px-5">Lấy lại mật khẩu</button>
			<br> <a class="text-decoration-none quenmk" href="${url}login">Về
				trang đăng nhập</a>
		</div>
	</div>
</form>
